...
export const UI_COLORS = {
  ...
  compound: '#ecd06a', // gold — named compound payoff (canonical: --color-compound in index.css)
} as const;

export const PIXI_COLORS = {
  crit: 0xfbbf24, healing: 0x34d399, blocked: 0x94a3b8, dodged: 0x60a5fa,
  compound: 0xecd06a, // gold — named compound payoff (canonical: --color-compound in index.css)
} as const;
