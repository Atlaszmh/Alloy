...
describe('Phase Machine', () => {
  ...
  it('transitions duel(1) -> draft(2) when no winner yet', () => {
    const results: DuelResult[] = [
      { round: 1, winner: 0, finalHP: [50, 0], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
    ];
  ...
  it('transitions duel(2) -> draft(3) when tied 1-1', () => {
    const results: DuelResult[] = [
      { round: 1, winner: 0, finalHP: [50, 0], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
      { round: 2, winner: 1, finalHP: [0, 50], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
    ];
  ...
  it('transitions duel(2) -> complete when 2-0', () => {
    const results: DuelResult[] = [
      { round: 1, winner: 0, finalHP: [50, 0], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
      { round: 2, winner: 0, finalHP: [50, 0], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
    ];
    const phase: MatchPhase = { kind: 'duel', round: 2 };
    const next = getNextPhase(phase, results);
  ...
  it('transitions duel(3) -> complete', () => {
    const results: DuelResult[] = [
      { round: 1, winner: 0, finalHP: [50, 0], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
      { round: 2, winner: 1, finalHP: [0, 50], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
      { round: 3, winner: 1, finalHP: [0, 50], duration: 10, wasTiebreak: false, p0DamageDealt: 0, p1DamageDealt: 0 },
    ];
